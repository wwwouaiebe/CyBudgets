/* ---------------------------------------------------------------------------- */
//! CyWxShowRequestAttributionsGroupsMediator.h
/* ---------------------------------------------------------------------------- */
//!
//! \file CyWxShowRequestAttributionsGroupsMediator.h
//! \brief header file for class CyWxShowRequestAttributionsGroupsMediator
//!
/* ----------------------------------------------------------------------------
...
//! \class CyWxShowRequestAttributionsGroupsMediator
...
//! - create an instance of the class CyWxShowRequestAttributionsGroupsMediator or an instance of a class derived from CyWxShowRequestAttributionsGroupsMediator
...
class CyWxShowRequestAttributionsGroupsMediator: public CyWxShowRequestMediator
{
	...
	public:
		...
		//! \fn CyWxShowRequestAttributionsGroupsMediator ( CySqlBuilder* pSqlBuilder )
		//! @param [ in ] pSqlBuilder a SQL builder used to do the SQL operations
		//!
		//! constructor

		explicit CyWxShowRequestAttributionsGroupsMediator ( CySqlBuilder* pSqlBuilder );

		//! \fn ~CyWxShowRequestAttributionsGroupsMediator ( ) 
		//! destructor

		virtual ~CyWxShowRequestAttributionsGroupsMediator ( );
	...
	private:
		...
		//! \fn CyWxShowRequestAttributionsGroupsMediator ( const CyWxShowRequestAttributionsGroupsMediator& )
		//! copy constructor
		//! not implemented

		CyWxShowRequestAttributionsGroupsMediator ( const CyWxShowRequestAttributionsGroupsMediator& );

		//! \fn operator = ( const CyWxShowRequestAttributionsGroupsMediator& ) 
		//! operator =
		//! \return a reference to a CyWxShowRequestAttributionsGroupsMediator object
		//! not implemented

		CyWxShowRequestAttributionsGroupsMediator& operator = ( const CyWxShowRequestAttributionsGroupsMediator& );
